...
<table border="1">
    <?php 
        ...
        $query = "SELECT * FROM registration WHERE reg_id LIKE '%$search%' ||LastName LIKE '%$search%' || FirstName LIKE '%$search%' || MiddleName LIKE '%$search%' || Sex LIKE '%$search%' || CivilStat LIKE '%$search%' || UserName LIKE '%$search%' || Password LIKE '%$search%'";
