          ...
          <tr>
            ...
            <td>
                <form action="index_edit.php" method="post">
                    <input type="hidden" name="in_editid" value="<?php echo $row['id']; ?>">
                    <button  type="submit" name="in_btnEdit" class="btn btn-info"> EDIT</button>
                </form>
            </td>
            <td>
                <form action="code.php" method="post">
                  <input type="hidden" name="in_deleteid" value="<?php echo $row['id']; ?>">
                  <button type="submit" name="in_btndelete" class="btn btn-danger"> DELETE</button>
                </form>
            </td> 
          </tr>
          <?php
